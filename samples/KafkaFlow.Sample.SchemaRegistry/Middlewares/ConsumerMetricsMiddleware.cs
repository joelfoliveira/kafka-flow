...
{
    internal class ConsumerMetricsMiddleware : IMessageMiddleware
    {
        public Task Invoke(IMessageContext context, MiddlewareDelegate next)
        {
            ...
            if (isAvro)
            {
                Console.WriteLine($"Consuming Avro message with schema: {messageType}");
            }
            else
            {
                Console.WriteLine($"Consuming object with type: {messageType}");
            }
